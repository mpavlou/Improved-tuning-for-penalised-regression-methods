...
Our evaluations with real and simulated data show that that modified and bootstrap tuning for Ridge and Lasso can substantially improve the selection of λ, resulting in improved CS compared to the standard tuning method. They also improve predictions compared to MLE. 
